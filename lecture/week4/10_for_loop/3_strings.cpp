...
int main()
{
    ...
    // length of a string
    // string_var.length();
    cout << full_name.length() << endl; // number of character in the string
   ...
   // indexing - [] - int
    ...
    // substring
    // string_var.substr(starting_position,num_of_characters) // int


    cout << full_name.substr(0,3) << " is a substring of " << full_name << endl;
    cout << full_name.substr(2,8) << " is a substring of " << full_name << endl;
    cout << full_name.substr(7) << " is a substring of " << full_name << endl;   
    cout << full_name.substr() << " is a substring of " << full_name << endl;  
